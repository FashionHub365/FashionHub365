...
const StoreFollower = require('./StoreFollower');
const StoreRating = require('./StoreRating');
const StoreUpgradeRequest = require('./StoreUpgradeRequest');
...
const AffiliateProgram = require('./AffiliateProgram');
