    ...
    >
      <div className="flex flex-col w-[632px] items-center gap-[30px] relative flex-[0_0_auto]">
        ...
        <Link
          ...
          className="all-[unset] box-border flex w-60 items-center justify-center gap-2.5 px-0 py-3 relative flex-[0_0_auto] bg-white cursor-pointer hover:opacity-90 transition-opacity focus:outline-2 focus:outline-offset-2 focus:outline-white no-underline"
