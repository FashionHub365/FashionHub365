                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="bg-gray-50 border-b border-gray-200">
                                        ...
                                        <th className="text-right text-xs font-semibold text-gray-500 uppercase tracking-wide px-6 py-4">Price</th>
                                        <th className="text-center text-xs font-semibold text-gray-500 uppercase tracking-wide px-6 py-4">Variants</th>
                                        <th className="text-center text-xs font-semibold text-gray-500 uppercase tracking-wide px-6 py-4">Status</th>
                                        <th className="text-center text-xs font-semibold text-gray-500 uppercase tracking-wide px-6 py-4">Out of Stock</th>
                                        <th className="text-center text-xs font-semibold text-gray-500 uppercase tracking-wide px-6 py-4">Actions</th>
                                    </tr>
                                </thead>
                                            ...
                                            <tr key={product._id} className="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td className="px-6 py-4 text-center">
                                                    <button
                                                        ...
                                                        title={isInactive ? 'Out of stock — click to enable' : 'Active — click to disable'}
