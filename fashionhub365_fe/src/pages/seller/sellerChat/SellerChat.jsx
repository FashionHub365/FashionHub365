...
const SellerChat = () => {
    const { sessions, activeSession, messages, sendMessage, openSession } = useChat();
    const { user } = useAuth();
    ...
    return (
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 flex overflow-hidden h-[calc(100vh-140px)] min-h-[500px] ring-1 ring-black/5">
            {/* Sidebar: Danh sách chat */}
            <div className="w-1/3 flex flex-col bg-gray-50/50 relative z-20 shadow-[4px_0_24px_rgba(0,0,0,0.06)]">
